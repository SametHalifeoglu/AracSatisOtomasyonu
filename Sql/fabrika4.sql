...
-- ----------------------------
INSERT INTO `bankserver` VALUES (29, 'samet', 'halife', 1234567891234567, '111', '12345');
...
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8 COLLATE = utf8_turkish_ci ROW_FORMAT = Compact;
...
insert into bankserver values(null,new.musAd,new.musSoyadi,@num,@tarih,@kod);
